...
# In[79]:
path_model = 'C:/Users/Reg2017/Desktop/final_step/JeffDropsIT/DirtRoad69/face/inception/final_model/'
...
def transfer_values(image_path=None, image=None):
    ...
    return transfer_values.reshape(1, 2048), time_dif

path_model_old = 'C:/final_model/'
def restore():
    # restore model and it variables
    sess = tf.Session()
    saver = tf.train.import_meta_graph(path_model_old+'inception.cpkl.meta')
    saver.restore(sess, tf.train.latest_checkpoint(path_model_old))
